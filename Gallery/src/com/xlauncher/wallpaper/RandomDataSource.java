...
package com.xlauncher.wallpaper;

import java.io.IOException;
import java.net.URISyntaxException;

import com.xlauncher.cache.CacheService;
import com.xlauncher.cache.ImageList;
import com.xlauncher.media.UriTexture;
import com.xlauncher.media.Util;
...
public class RandomDataSource implements Slideshow.DataSource {
    ...
    public Bitmap getBitmapForIndex(Context context, int currentSlideshowCounter) {
        ...
        try {
            int max_resolution =
                    context.getResources().getInteger(com.xlauncher.media.R.integer.max_resolution);
