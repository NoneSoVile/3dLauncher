...
import com.xlauncher.cache.CacheService;
import com.xlauncher.wallpaper.RandomDataSource;
import com.xlauncher.wallpaper.Slideshow;
...
public final class Gallery extends Activity {
    public static final String REVIEW_ACTION = "com.xlauncher.media.action.REVIEW";
...
//        mRenderView.setRootLayer(mGridLayer);
        ...
        mAppsLayer = new AppsLayer(this, (int) (60.0f * App.PIXEL_DENSITY), (int) (60.0f * App.PIXEL_DENSITY), new GridLayoutInterface(4),
                mRenderView);
...
/*
    ...
    public void onDestroy() {
        ...
        if (mAppsLayer != null) {
            DataSource dataSource = mAppsLayer.getDataSource();
            if (dataSource != null) {
                dataSource.shutdown();
            }
            if(dataSource instanceof AppsDataSource){
            	AppsDataSource lDataSource = (AppsDataSource) dataSource;
            	unregisterReceiver(lDataSource);
            }
    ...
    private void initializeDataSource() {
        ...
        final AppsDataSource appsDataSource = new AppsDataSource(Gallery.this);
        mAppsDataSource = appsDataSource;
        IntentFilter filter = new IntentFilter(Intent.ACTION_PACKAGE_ADDED);
        filter.addAction(Intent.ACTION_PACKAGE_REMOVED);
        filter.addAction(Intent.ACTION_PACKAGE_CHANGED);
        filter.addDataScheme("package");
        registerReceiver(mAppsDataSource, filter);
...
//            }
            mAppsLayer.setDataSource(appsDataSource);
