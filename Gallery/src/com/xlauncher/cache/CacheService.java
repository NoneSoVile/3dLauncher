...
import com.xlauncher.media.DataSource;
import com.xlauncher.media.DiskCache;
import com.xlauncher.media.Gallery;
import com.xlauncher.media.LocalDataSource;
import com.xlauncher.media.LongSparseArray;
import com.xlauncher.media.MediaFeed;
import com.xlauncher.media.MediaItem;
import com.xlauncher.media.MediaSet;
import com.xlauncher.media.Shared;
import com.xlauncher.media.SortCursor;
import com.xlauncher.media.UriTexture;
import com.xlauncher.media.Utils;

public final class CacheService extends IntentService {
    public static final String ACTION_CACHE = "com.xlauncher.cache.action.CACHE";
    ...
    public static final String getCachePath(final String subFolderName) {
        return Environment.getExternalStorageDirectory() + "/Android/data/com.xlauncher.media/cache/" + subFolderName;
    }
    ...
    private static final void writeItemsForASet(final MediaSet set) {
        final ByteArrayOutputStream bos = new ByteArrayOutputStream();
        final DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(bos, 256));
        Log.d(TAG, "writeItemsForASet for set " + set.mName);
        try {
